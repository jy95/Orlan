...
export default class Player {
    ...
    moveCard(index_from, index_to) {
        let check = 0 <= index_from < this._cards.length && 0 <= index_to < this._cards.length;
        if (check) {
    ...
    removeTempCombination(index) {
        let check = 0 <= index < this._tempCombinations.length;
        if (check) {
    ...
    addCardToTempCombination(cardIndex, combIndex) {
        let check = 0 <= cardIndex < this._cards.length && 0 <= combIndex < this._tempCombinations.length;
        if (check) {
